        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="h2 fw-bold text-dark mb-1"><i class="bi bi-calendar3 me-2"></i>Admin Timesheet Calendar
                        </h1>
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="btn-group w-100" role="group">
                            ...
                            <label class="btn btn-outline-primary" for="viewYearly">Yearly</label>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header"
                    style="background: linear-gradient(135deg, #4e54c8 0%, #8f94fb 100%); color: white;">
...
@push('scripts')
    <script>
        ...
        // 🛠️ Step 3: Add Missing Function (Placed Globally)
        function renderDaySummary(summary) {
            let html = '<div class="small">';
            html += `<div><span class="text-success fw-bold">${summary.approved_count}</span> ✅</div>`;
            html += `<div><span class="text-warning fw-bold">${summary.pending_count}</span> ⏳</div>`;
            html += `<div><span class="text-danger fw-bold">${summary.rejected_count}</span> ❌</div>`;
            html += '</div>';
            return html;
        }
        ...
        function loadCalendarData() {
            ...
            fetch(`/admin/timesheet-calendar/data?${params}`)
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        // 🛠️ Step 5: Add "No Data Found" check (Correctly placed inside .then block)
                        if (!data.calendar_data || data.calendar_data.length === 0) {
                            document.getElementById('calendarContainer').innerHTML = `
                                <div class="p-5 text-center text-muted">
                                    <i class="bi bi-calendar-x fs-1 mb-3"></i>
                                    <p>No timesheets found for this selection</p>
                                </div>`;
            ...
            // The misplaced `if` block for Step 5 is removed from here!
        }
        ...
        function renderMonthlyCalendar(data) {
            ...
            while (currentDate <= lastDay || currentDate.getDay() !== 0) {
                ...
                for (let i = 0; i < 7; i++) {
                    ...
                    // FIX: Call the global renderDaySummary function
                    if (dayData && dayData.summary) {
                        html += renderDaySummary(dayData.summary);
                    }
                    
                    // NOTE: The previous, internal definition of renderDaySummary has been deleted from here.
